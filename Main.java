...
class Food {
    ...
    private static final String MENU_FILE_PATH = "D:\\java assignment\\foodsystemm\\src\\menu.txt";
            ...
            for (String food_name : foodQuantities.keySet()) {
                ...
                for (String beverage : beverageQuantities.keySet()) {
                    ...
                    for (String dessert : dessertQuantities.keySet()) {
                        ...
                        // Process each combination of food_name, beverage, and dessert
                        Food foodname = new Food(food_name, beverage, dessert);
                        // Insert the food data or perform any other operations
